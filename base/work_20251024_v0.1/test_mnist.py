...
class ClassificationTrainer(BaseTrainer):
    ...
    def configure_early_stoppers(self):
        return dict(
            train=EarlyStopper(patience=3, mode='min', min_delta=0.001),
            valid=EarlyStopper(patience=5, mode='max', min_delta=0.001, target_value=0.99)
        )
...
def main():
    ...
    trainer.save_model(os.path.join(output_dir, "mnist_final.pth"))
