...
# from c_dcgan import CDiscriminator32, CGenerator32
...
if __name__ == "__main__":
    ...
    num_classes = 10
    discriminator = CDiscriminator32(num_classes=num_classes, in_channels=3, base=64)
    generator = CGenerator32(num_classes=num_classes, latent_dim=100, out_channels=3, base=64)
    gan = CGAN(discriminator, generator)
