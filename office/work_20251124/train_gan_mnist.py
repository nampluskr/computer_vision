...
from datasets import MNIST, MNIST, MNIST
...
if __name__ == "__main__":
    ...
    if 1:
        LOSS_TYPE = "hinge"
        OUTPUT_DIR = "./outputs_gan_mnist"
        FILENAME = f"mnist_gan-{LOSS_TYPE}"

        set_seed(SEED)
        dataset = MNIST(root_dir="/home/namu/myspace/NAMU/datasets/mnist", split="train",
    ...
    if 1:
        NUM_CLASSES = 10
        LOSS_TYPE = "hinge"
        OUTPUT_DIR = "./outputs_cgan_mnist"
        FILENAME = f"mnist_cgan-{LOSS_TYPE}"
    ...
    if 1:
        NUM_CLASSES = 10
        LOSS_TYPE = "hinge"
        OUTPUT_DIR = "./outputs_acgan_mnist"
        FILENAME = f"mnist_acgan-{LOSS_TYPE}"
