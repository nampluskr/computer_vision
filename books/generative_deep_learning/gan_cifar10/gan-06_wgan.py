...
class WGAN(nn.Module):
    def __init__(self, critic, generator, latent_dim=None, device=None):
        ...
        self.c_optimizer = torch.optim.RMSprop(self.d_model.parameters(), lr=5e-5)
        self.g_optimizer = torch.optim.RMSprop(self.g_model.parameters(), lr=5e-5)
    ...
    def train_step(self, batch):
        ...
        return dict(critic_loss=d_loss, gen_loss=g_loss)
