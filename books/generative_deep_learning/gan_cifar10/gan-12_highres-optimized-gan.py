""" GAN-N: HighRes-Optimized GAN
- Generator: ResBlockUp + PixelNorm + LeakyReLU
- Discriminator: ResBlockDown + SpectralNorm everywhere
- Loss: Hinge Loss
"""
...
class HingeGAN(nn.Module):
    ...
    def d_loss_fn(self, real_score, fake_score):
        return torch.relu(1 - real_score).mean() + torch.relu(1 + fake_score).mean()
